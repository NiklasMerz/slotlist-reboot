<template>
  <div>
    ...
    <div v-if="hasMissionAnyRequiredDLCs" class="text-center small text-muted">
      <img src="/img/dlc-icons/aow.png" width="12px" alt="Art of War" /> {{ $t('mission.requiredDLCs.aow') }} | 
      <img src="/img/dlc-icons/apex.png" width="12px" alt="Apex" /> {{ $t('mission.requiredDLCs.apex') }} | 
      <img src="/img/dlc-icons/contact.png" width="12px" alt="Contact" /> {{ $t('mission.requiredDLCs.contact') }} | 
      <img src="/img/dlc-icons/csla.png" width="12px" alt="CSLA Iron Curtain" /> {{ $t('mission.requiredDLCs.csla') }} | 
      <img src="/img/dlc-icons/ef.png" width="12px" alt="Expeditionary Forces" /> {{ $t('mission.requiredDLCs.ef') }} | 
      <img src="/img/dlc-icons/gm.png" width="12px" alt="Global Mobilization" /> {{ $t('mission.requiredDLCs.gm') }} | 
      <img src="/img/dlc-icons/helicopters.png" width="12px" alt="Helicopters" /> {{ $t('mission.requiredDLCs.helicopters') }} | 
      <img src="/img/dlc-icons/jets.png" width="12px" alt="Jets" /> {{ $t('mission.requiredDLCs.jets') }} | 
      <br/>
      <img src="/img/dlc-icons/karts.png" width="12px" alt="Karts" /> {{ $t('mission.requiredDLCs.karts') }} | 
      <img src="/img/dlc-icons/lawsofwar.png" width="12px" alt="Laws of War" /> {{ $t('mission.requiredDLCs.laws-of-war') }} | 
      <img src="/img/dlc-icons/marksmen.png" width="12px" alt="Marksmen" /> {{ $t('mission.requiredDLCs.marksmen') }} |
      <img src="/img/dlc-icons/rf.png" width="12px" alt="Reaction Forces" /> {{ $t('mission.requiredDLCs.rf') }} | 
      <br/>
      <img src="/img/dlc-icons/spe.png" width="12px" alt="Spearhead 1944" /> {{ $t('mission.requiredDLCs.spe') }} | 
      <img src="/img/dlc-icons/tacops.png" width="12px" alt="Tac-Ops" /> {{ $t('mission.requiredDLCs.tac-ops') }} | 
      <img src="/img/dlc-icons/tanks.png" width="12px" alt="Tanks" /> {{ $t('mission.requiredDLCs.tanks') }} | 
      <img src="/img/dlc-icons/vn.png" width="12px" alt="S.O.G. Prairie Fire" /> {{ $t('mission.requiredDLCs.vn') }} | 
      <img src="/img/dlc-icons/ws.png" width="12px" alt="Western Sahara" /> {{ $t('mission.requiredDLCs.ws') }}
    </div>
  </div>
</template>
