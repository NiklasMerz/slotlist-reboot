<template>
  <div>
    <b-jumbotron header="Sign in using Steam" lead="slotlist.online uses Steam OpenID authentication. This allows you to use your existing Steam account to log into our site." v-if="!working">
      <p class="text-justify">
        ...
        <router-link to="/">slotlist.online</router-link>.
