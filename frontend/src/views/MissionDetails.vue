            ...
            <b-form-group :label="$t('mission.slotlist.filter')" label-for="missionSlotlistFilter">
              ...
              <div class="group" id="missionSlotlistRequiredDLCsFilter" v-if="haveMissionSlotsAnyRequiredDLCs || (missionSlotlistRequiredDLCsFilter && missionSlotlistRequiredDLCsFilter.length > 0)">
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="aow" value="aow">
                  <img src="/static/img/dlc-icons/aow.png" width="16px" alt="Art of War" /> {{ $t('mission.requiredDLCs.aow') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="apex" value="apex">
                  <img src="/static/img/dlc-icons/apex.png" width="16px" alt="Apex" /> {{ $t('mission.requiredDLCs.apex') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="contact" value="contact">
                  <img src="/static/img/dlc-icons/contact.png" width="16px" alt="Contact" /> {{ $t('mission.requiredDLCs.contact') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="csla" value="csla">
                  <img src="/static/img/dlc-icons/csla.png" width="16px" alt="CSLA Iron Curtain" /> {{ $t('mission.requiredDLCs.csla') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="ef" value="ef">
                  <img src="/static/img/dlc-icons/ef.png" width="16px" alt="Expeditionary Forces" /> {{ $t('mission.requiredDLCs.ef') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="gm" value="gm">
                  <img src="/static/img/dlc-icons/gm.png" width="16px" alt="Global Mobilization" /> {{ $t('mission.requiredDLCs.gm') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="helicopters" value="helicopters">
                  <img src="/static/img/dlc-icons/helicopters.png" width="16px" alt="Helicopters" /> {{ $t('mission.requiredDLCs.helicopters') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="jets" value="jets">
                  <img src="/static/img/dlc-icons/jets.png" width="16px" alt="Jets" /> {{ $t('mission.requiredDLCs.jets') }}
                </b-form-checkbox>
                <br />
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="karts" value="karts">
                  <img src="/static/img/dlc-icons/karts.png" width="16px" alt="Karts" /> {{ $t('mission.requiredDLCs.karts') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="laws-of-war" value="laws-of-war">
                  <img src="/static/img/dlc-icons/lawsofwar.png" width="16px" alt="Laws of War" /> {{ $t('mission.requiredDLCs.laws-of-war') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="marksmen" value="marksmen">
                  <img src="/static/img/dlc-icons/marksmen.png" width="16px" alt="Marksmen" /> {{ $t('mission.requiredDLCs.marksmen') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="rf" value="rf">
                  <img src="/static/img/dlc-icons/rf.png" width="16px" alt="Reaction Forces" /> {{ $t('mission.requiredDLCs.rf') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="tac-ops" value="tac-ops">
                  <img src="/static/img/dlc-icons/tacops.png" width="16px" alt="Tac-Ops" /> {{ $t('mission.requiredDLCs.tac-ops') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="tanks" value="tanks">
                  <img src="/static/img/dlc-icons/tanks.png" width="16px" alt="Tanks" /> {{ $t('mission.requiredDLCs.tanks') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="vn" value="vn">
                  <img src="/static/img/dlc-icons/vn.png" width="16px" alt="S.O.G. Prairie Fire" /> {{ $t('mission.requiredDLCs.vn') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="spe" value="spe">
                  <img src="/static/img/dlc-icons/spe.png" width="16px" alt="Spearhead 1944" /> {{ $t('mission.requiredDLCs.spe') }}
                </b-form-checkbox>
                <b-form-checkbox v-model="missionSlotlistRequiredDLCsFilter" name="ws" value="ws">
                  <img src="/static/img/dlc-icons/ws.png" width="16px" alt="Western Sahara" /> {{ $t('mission.requiredDLCs.ws') }}
                </b-form-checkbox>
              </div>
            </b-form-group>
          </div>
...
@media (max-width: 768px) {
  ...
  .row.justify-content-center .click-confirm {
    flex: 1 1 auto;
    min-width: 0;
  }
  
  .row.justify-content-center .click-confirm .btn {
    width: 100%;
  }
